...
const SettingsSection: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => (
              ...
              try {
                ...
                if (
                  ...
                  if (!importData.gameState) {
                    throw new Error(
                      'Invalid save file format: missing game state'
                    );
                  }

                  // Validate game state structure (basic validation)
                  if (
                    !importData.gameState.version ||
                    !importData.gameState.player
                  ) {
                ...
                Alert.alert(
                  'Import Failed',
                  `Could not import save file: ${error instanceof Error ? error.message : 'Unknown error'}`
                );
              }
            },
          },
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              console.log('Starting reset progress...');

              // Clear all beacons and reset quantum data
              console.log('Clearing all beacons...');
              gameController.clearAllBeacons();

              // For web, we'll skip the nested settings dialog for now
              // and just reset both game progress and settings
              if (Platform.OS === 'web') {
                console.log('Resetting settings...');
                await resetSettings();
              } else {
                // On native, ask about settings reset
                const shouldResetSettings = await new Promise<boolean>(
                  resolve => {
                    Alert.alert(
                      'Reset Settings Too?',
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      thumbColor={
                        settings.autoSaveInterval > 0 ? '#F9FAFB' : '#9CA3AF'
                      }
                    />
                  }
                />
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      trackColor={{ false: '#374151', true: '#4F46E5' }}
                      thumbColor={
                        settings.hapticsEnabled ? '#F9FAFB' : '#9CA3AF'
                      }
                    />
                  }
                />
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      trackColor={{ false: '#374151', true: '#4F46E5' }}
                      thumbColor={
                        settings.debugInfoEnabled ? '#F9FAFB' : '#9CA3AF'
                      }
                      disabled={!__DEV__}
                    />
                  }
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      trackColor={{ false: '#374151', true: '#4F46E5' }}
                      thumbColor={
                        settings.largeTextEnabled ? '#F9FAFB' : '#9CA3AF'
                      }
                    />
                  }
                />
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      trackColor={{ false: '#374151', true: '#4F46E5' }}
                      thumbColor={
                        settings.highContrastEnabled ? '#F9FAFB' : '#9CA3AF'
                      }
                    />
                  }
                />
                ...
                <SettingsRow
                  ...
                  control={
                    <Switch
                      ...
                      trackColor={{ false: '#374151', true: '#4F46E5' }}
                      thumbColor={
                        settings.reduceAnimationsEnabled ? '#F9FAFB' : '#9CA3AF'
                      }
                    />
                  }
                />
